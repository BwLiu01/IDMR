...
class InternVLChatModel(PreTrainedModel):
    ...
    def __init__(self, config: InternVLChatConfig, vision_model=None, language_model=None, use_flash_attn=True, tokenizer=None):
    ...
    def get_lora_target_modules(self):
        ...
        return ['attn.qkv', 'attn.proj', 'mlp.fc1', 'mlp.fc2'] + target_modules
    ...
    def forward(
            ...
            image_flags: Optional[torch.LongTensor] = None,  # [batch_size], 1表示有图片，0表示无图片
